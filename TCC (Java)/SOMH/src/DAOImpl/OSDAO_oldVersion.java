 ...
 * @author andro
 */
public class OSDAO_oldVersion implements OSDAOInterface {

    @Override
    public void insert(Equipamento equipamento, OS os, ArrayList<Acessorio> acessorios, OSStatus osStatus) throws OSDAOException_oldVersion {
        Connection conexao;
        String sql;
        ...
        try {
            ...
            throw new OSDAOException_oldVersion(ex);
        }
    }
